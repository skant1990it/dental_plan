...
class DashboardTable
{
  ...
  public function doctorDetails(){
    ...
    public function saveDoctor($doc_id,$doc_firstname,$doc_lastname,$doc_email,$doc_phone,$doc_zip,$doc_address,$doc_phone2,$doc_sex,$doc_speciality,$doc_license_no,$doc_contact_person,$doc_status,$doc_username){
        if($doc_status=='on') {
         $docstatus = 1;
          } else {
            $docstatus = 0;
 ...
 public function saveRole($role,$permission)
  ...
  public function selectPlansAsDoc($doc_id){
   ...
   public function addPlans($doc_id,$plan_name,$heading_line,$plan_monthly_price,$plan_yearly_price,$addon_monthly_price,$addon_yearly_price){
     ...
     $lastplanId = $this->adapter->getDriver()->getLastGeneratedValue(); 
		  return $lastplanId;
    } 
